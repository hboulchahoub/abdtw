...
<div class="quiz-window">
	...
	<div class="col2">
			...
			<f:form modelAttribute="produit" action="../ps/crud">
				<label>id</label>
				<f:input path="id" maxlength="19" placeholder="id"
					cssClass="form-control" />

				<label>name</label>
				<f:input path="name" maxlength="19" placeholder="name"
					cssClass="form-control" />
	...
	<div class="quiz-window-body">
		...
		<div class="gui-window-awards">
			...
			<c:if test="${not empty l}">
				<c:forEach items="${l}" var="prd">
					<ul class="guiz-awards-row  guiz-awards-row-even">
						<li class="guiz-awards-title">${prd.id }</li>
						<li class="guiz-awards-title">${prd.name }</li>
						<li><a
							href="${pageContext.request.contextPath}/ps/load/${prd.id}"
							...
							href="${pageContext.request.contextPath}/ps/delete/${prd.id}"
							class="btn btn-primary a-btn-slide-text"> <span
